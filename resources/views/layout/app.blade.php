        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
              ...
              <li class="nav-item"><a class="nav-link {{request()->routeIs('quienes_somos') ? 'active' : '' }}" href="{{route('quienes_somos')}}">Quiénes Somos</a></li>
            ...
            <div class="d-flsex py-3 py-lg-0 text-center">
              {{--<button class="btn btn-link text-1000 fw-medium order-1 order-lg-0" type="button">Indentifícate</button>--}}
          </div>
        </div>
      </nav>
